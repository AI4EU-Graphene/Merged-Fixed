...
export PORTAL_BE_IMAGE=cicd.ai4eu-dev.eu:7444/ai4eu/acumos-portal-be:4.0.14-ai4eu-v27
export PORTAL_FE_IMAGE=cicd.ai4eu-dev.eu:7444/ai4eu/acumos-portal-fe:4.0.14-ai4eu-v27
...
export KUBERNETES_CLIENT_IMAGE=cicd.ai4eu-dev.eu:7444/acumos/kubernetes-client:3.0.29-ai4eu-v3
export MICROSERVICE_GENERATION_IMAGE=$ACUMOS_RELEASE/acumos/microservice-generation:3.6.0
export ONBOARDING_IMAGE=cicd.ai4eu-dev.eu:7444/ai4eu/onboarding-app:4.6.17-ai4eu
...
export BLUEPRINT_ORCHESTRATOR_IMAGE=cicd.ai4eu-dev.eu:7444/generic-parallel-orchestrator/orchestrator_container:1.2
...
export ACUMOS_CDS_VERSION=3.2-rev1
