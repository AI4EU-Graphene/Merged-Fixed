...
function new_db() {
  ...
  wget https://github.com/ai4eu/common-dataservice/raw/master/cmn-data-svc/cmn-data-svc-server/db-scripts/cmn-data-svc-ddl-dml-$ACUMOS_CDS_VERSION.sql
