		...
		.component(
				'modelDetails',
				{
					...
					controller : function($scope, $location, $http, $rootScope,
						...
						$scope.loginUserID = "";
						console.log("model-details.component");
					    ...
					    $scope.triggerDeployment = function(menuEntry){
					        ...
					        if(menuEntry.produces_download) {
					            $window.location.assign(menuEntry.local_service_path + $scope.solutionId + "/" + $scope.revisionId+"?jwtToken="+$scope.auth);
					        } else {
					            $window.open(menuEntry.local_service_path + $scope.solutionId + "/" + $scope.revisionId+"?jwtToken="+$scope.auth, "_blank");
					        }
					    }
...
/*Deploy to k8s*/
						...
						$scope.deployLocalPackage = function(){
							$window.location.assign("/package/getSolutionZip/" + $scope.solutionId + "/" + $scope.revisionId+"?jwtToken="+$scope.auth);
						}
