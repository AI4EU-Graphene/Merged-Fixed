...
CREATE TABLE C_SOURCE_SOL_REV_TARGET_SOL_REV_MAP (
  ...
  CONSTRAINT C_SOURCE_SOL_REV_TARGET_SOL_REV_MAP_C_SOLUTION_REV_SOURCE FOREIGN KEY (SOURCE_ID) REFERENCES C_SOLUTION_REV (REVISION_ID),
  CONSTRAINT C_SOURCE_SOL_REV_TARGET_SOL_REV_MAP_C_SOLUTION_REV_TARGET FOREIGN KEY (TARGET_ID) REFERENCES C_SOLUTION_REV (REVISION_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
