...
-- DDL and DML for tables managed by the Common Data Service version 3.2.*
-- No database is created or specified to allow flexible deployment;
-- also see script cmn-data-svc-dml-opt-3.2-rev1.sql with images.
...
INSERT INTO C_HISTORY (COMMENT, CREATED_DATE) VALUES ('cmn-data-svc-ddl-dml-3.2-rev1', NOW());
