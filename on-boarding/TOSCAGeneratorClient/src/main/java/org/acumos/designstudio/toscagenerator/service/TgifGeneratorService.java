...
public class TgifGeneratorService {
	 ...
	 * @return
	 */
	private Tgif populateTgif(String version, String solutionName, String description, JSONObject protobufJson) throws Exception {
	 ...
	 */
	@SuppressWarnings("unchecked")
	private Provide[] getProvides(JSONObject protobufJson) throws Exception {
	 ...
	 */
	@SuppressWarnings("unchecked")
	private Call[] getCalls(JSONObject protobufJson) throws Exception {
	 ...
	 * @return
	 */
	private JSONObject getMsgJson(String msgName, JSONArray listOfMessages) throws Exception {
		@SuppressWarnings("unchecked")
		...
		if (!found) {
			throw new Exception("could not lookup message named '"+msgName+"'!");
		}
		return message;
	}
}
