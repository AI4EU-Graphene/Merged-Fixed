...
public class ConfigurationProperties {
	...
	@Value("#{'${modelMatchingExcludedMessages}'.split(',')}")
	private List<String> modelMatchingExcludedMessages = new ArrayList<>();
	...
	/**
	 * @return Message names that are excluded from finding matching models.
	 */
	public List<String> getModelMatchingExcludedMessages() {
		return modelMatchingExcludedMessages;
	}
